      ...
      <a href=${`https://console.whr.ai/detailpage?widgetId=${this.customizedData.widgetId}&eventId=${this.event.id}`} target="_blank" class="card">
        <img src=${this.event.logoUrl} alt="placeholder" class="banner"/>
                <div class="date_location_nameContainer">
                    ...
                    ${this.event.type === "SUB" ? this.partyPopIcon() : this.event.type === "MAIN" && this.event.event_type === "Tradeshow" ? this.tradeshowIcon() : this.event.type === "MAIN" && this.event.event_type === "Conference" ? this.conferenceIcon() : this.event.type === "MAIN" && this.event.event_type === "Workshop" ? this.workshopIcon() : this.widgetDefaultIcon()}
                    </div>
                    <div class="line"></div>
                    <div class="name_locationContainer">
                        ...
                        ${this.event.name.length > 15 ? `${this.event.name.substring(0, 15)}...`:this.event.name}
                        </div>
                    </div>
                </div>
